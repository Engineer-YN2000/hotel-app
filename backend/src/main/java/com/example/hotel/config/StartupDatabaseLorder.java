...
@Component
@Slf4j
public class StartupDatabaseLorder implements CommandLineRunner{
    private final RoomStockDao roomStockDao;
    private final RoomStockCacheService cacheService;

    // Doma2 DaoとキャッシュサービスをDI
    public StartupDatabaseLorder(RoomStockDao roomStockDao, RoomStockCacheService cacheService) {
